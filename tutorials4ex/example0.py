...
def main():
    # create colormaps
    field_colormap = vis.get_colormap_lut(
        "colormap_wave1", invert=False, black_level=-0.05
    )
    ...
    visualizer = vis.WaveVisualizer(
        field_colormap=field_colormap, intensity_colormap=intensity_colormap
    )
